...
public interface DoiCoInsuranceService {
	...
	PagebleDTO<DoiCoinsPolicyHdrDTO> getPolicyEntryListing(PageDetails pageDetail);

	PagebleDTO<DoiCoinsPremiumRefundDTO> getPremiumRefundEntryListing(PageDetails pageDetail);

	PagebleDTO<DoiCoinsClaimHdrDTO> getClaimListing(PageDetails pageDetail);
}
